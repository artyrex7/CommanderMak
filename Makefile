...
CFLAGS = -std=c++1z
OBJ_DIR = obj
OBJS = $(OBJ_DIR)/GameClient.o $(OBJ_DIR)/GameState.o $(OBJ_DIR)/Player.o $(OBJ_DIR)/EnemyEasy.o $(OBJ_DIR)/EnemyHard.o $(OBJ_DIR)/EnemyMedium.o $(OBJ_DIR)/EnemyEasy.o
...
$(OBJ_DIR)/EnemyEasy.o: EnemyEasy.cpp 
	$(CC) $(CFLAGS) -c EnemyEasy.cpp -o $@

$(OBJ_DIR)/EnemyMedium.o: EnemyMedium.cpp 
	$(CC) $(CFLAGS) -c EnemyMedium.cpp -o $@

$(OBJ_DIR)/EnemyHard.o: EnemyHard.cpp 
